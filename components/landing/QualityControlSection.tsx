      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="mx-auto w-11/12">
          ...
          <p className="text-center text-[#514A4A] mb-[40px] font-normal lg:text-lg text-sm">
            All assemblies are 100% inspected to IPC-A-610 criteria. We use
            X-Ray to inspect BGA and lead-less devices for reliable solder
            joints. We use semi-automated optical inspection equipment to
            inspect all components for correct markings and acceptable solder
            joints.
          </p>
          <div className="mt-6">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-[32px]">
              <div>
                <div>
                  ...
                  <div className="bg-white px-4 py-5 rounded-sm min-h-[120px] rounded-b-2xl">
