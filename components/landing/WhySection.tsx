        ...
        <div className="mx-auto w-11/12">
          <div className="bg-blue-100 lg:p-[60px] p-5 rounded-[10px]">
            ...
            <p className="text-center text-[#514A4A] mb-[40px] font-normal text-lg">
              With over 31 years experience working with many different
              industries including commercial, military and medical, we have
              built everything from circuit boards used in golf balls to circuit
              boards that go in the brain.
            </p>
