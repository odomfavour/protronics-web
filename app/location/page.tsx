          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 mb-10">
            <div>
              <p className="mb-5 text-base font-normal text-proDark">
                Protronics is an experienced electronics manufacturing services
                (EMS) partner based in San Jose, California and providing
                quick-turn PCB design, prototype, and production assembly to
                companies in Boston and its surrounding areas.
              </p>
              <p className="mb-5 text-base font-normal text-proDark">
                Protronics enables firms of all sizes to improve their
                production cycle while reducing manufacturing time and costs by
                ensuring product reliability, accuracy and performance through
                the utilization of:
              </p>
              <ul className="pl-6">
        ...
        <div className="w-11/12 mx-auto border-t-2">
          ...
          <div className="mb-5">
            ...
            <p className="text-lg font-normal text-proDark">
              ...
              choose a certified PCB assembly manufacturer and service provider,
              like Protronics to ensure optimal product performance, quality and
              reliability.
            </p>
          </div>
        </div>
