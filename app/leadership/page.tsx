          ...
          <div className="flex md:flex-row flex-col-reverse items-center gap-10 py-10">
            <div className="lg:w-3/5 w-full">
              <p className="text-lg font-normal text-[#101928] mb-5">
                ...
                cornerstone of our success. While our business model is strong,
                it is the passion, commitment, and trust of our team members
                that truly set us apart from the competition. These qualities
                are not just buzzwords for us; they are the driving force behind
                everything we do.
              </p>
              <p className="text-lg font-normal text-[#101928] mb-5">
                ...
                commitment, and trust that precedes us both locally and
                globally.
              </p>
              <p className="text-lg font-normal text-[#101928] mb-5">
